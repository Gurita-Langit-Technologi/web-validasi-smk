        ...
        (function () {
            r.implement(this, i),
                ...
                (this.getVariableValue = function (e, t, n) {
                    ...
                    if (/^[A-Z]\d+$/.test(t))
                        return (
                            (this.variables[t[0] + "__"] || {})[t.substr(1)] ||
                            ""
                        );
                    t = t.replace(/^TM_/, "");
                ...
                (this.insertSnippetForSelection = function (e, t) {
                    ...
                    o.forEach(function (e, t) {
                        ...
                        e.choices && !r.choices && (r.choices = e.choices),
                            r.push(e);
                ...
                (this.expandWithTab = function (e, t) {
                    ...
                    return (
                        r && e.tabstopManager && e.tabstopManager.tabNext(), r
                    );
                }),
                (this.expandSnippetForSelection = function (e, t) {
                    ...
                    return (
                        this.getActiveScopes(e).some(function (e) {
                            var t = o[e];
                            return (
                                t && (u = this.findMatchingSnippet(t, i, s)),
                                !!u
                            );
                        }, this),
                        u
                            ? t && t.dryRun
                                ...
                                : (e.session.doc.removeInLine(
                                  ...
                                  (this.variables.M__ = this.variables.T__ =
                                      null),
                                  !0)
                            : !1
                    );
        ...
        (function () {
            (this.attach = function (e) {
                ...
                (this.addTabstops = function (e, t, n) {
                    var r =
                        this.useLink ||
                        !this.editor.getOption("enableMultiselect");
                ...
                this.keyboardHandler.bindKeys({
                    Tab: function (e) {
                        if (
                            t.snippetManager &&
                            t.snippetManager.expandWithTab(e)
                        )
                            return;
            ...
            var r = e("../virtual_renderer").VirtualRenderer,
                ...
                l = function (e) {
                    ...
                    (n.focus = r),
                        ...
                        n.setHighlightActiveLine(!1),
                        n.session.highlight(""),
                        (n.session.$searchHighlight.clazz =
                    ...
                    (c.id = n.session.addMarker(
                        ...
                        (n.setSelectOnHover = function (e) {
                            e
                                ? l.id &&
                                  (n.session.removeMarker(l.id), (l.id = null))
                                : (l.id = n.session.addMarker(
                                      l,
                                      "ace_line-hover",
                                      "fullLine"
                                  ));
            ...
            (function () {
                (this.$init = function () {
                    return (
                        ...
                        (this.popup.focus = this.editor.focus.bind(
                            this.editor
                        )),
                        this.popup.on(
                            "show",
                    ...
                    (this.openPopup = function (e, t, n) {
                        this.popup || this.$init(),
                            ...
                            e.keyBinding.addKeyboardHandler(
                                this.keyboardHandler
                            );
                        var r = e.renderer;
                        ...
                        if (!n) {
                            ...
                            var i = r.layerConfig.lineHeight,
                                s = r.$cursorLayer.getPixelPosition(
                                    this.base,
                                    !0
                                );
                    ...
                    (this.updateCompletions = function (e, t) {
                        ...
                        if (t && t.matches) {
                            ...
                            return (
                                (this.base =
                                    this.editor.session.doc.createAnchor(
                                        n.row,
                                        n.column
                                    )),
                                (this.base.$insertRight = !0),
                        ...
                        this.gatherCompletions(
                            ...
                            function (t, n) {
                                ...
                                if (
                                    s.indexOf(n.prefix) !== 0 ||
                                    i != this.gatherCompletionsId
                                )
                                    return;
                    ...
                    (this.updateDocTooltip = function () {
                        ...
                        this.editor.completers.some(function (e) {
                            return (
                                e.getDocTooltip && (r = e.getDocTooltip(n)), r
                            );
                        }),
                                ...
                                ? r.left < 320
                                    ? n.isTopdown
                                        ...
                                        : ((t.style.top =
                                          ...
                                          (t.style.bottom = ""))
                                    : ((t.style.right =
                                          window.innerWidth - r.left + "px"),
                                      (t.style.left = ""))
                                : ((t.style.left = r.right + 1 + "px"),
                                  (t.style.right = ""));
                    }),
                    ...
                    (this.filterText = e),
                        ...
                        (t = t.sort(function (e, t) {
                            return (
                                ...
                                t.$score - e.$score ||
                                (e.caption || e.value).localeCompare(
                                    t.caption || t.value
                                )
                            );
                        }));
            ...
            var r = e("../snippets").snippetManager,
                ...
                f = {
                    getCompletions: function (e, t, n, r, i) {
                        if (t.$mode.completer)
                            return t.$mode.completer.getCompletions(
                                e,
                                t,
                                n,
                                r,
