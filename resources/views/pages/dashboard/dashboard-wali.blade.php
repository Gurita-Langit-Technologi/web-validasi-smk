...
@section('breadcrumb')
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">Dashboard Wali Kelas</li>
        </ol>
    </nav>
@endsection
...
@section('content')
    <div class="d-flex justify-content-between align-items-center flex-wrap grid-margin">
        <div>
            <h4 class="mb-3 mb-md-0">Selamat Datang, {{ $waliKelas->nama_wali }}</h4>
            <h5 class="mb-3 mb-md-0">Kelas {{ $waliKelas->kelas->nama_kelas }}</h5>
        </div>
